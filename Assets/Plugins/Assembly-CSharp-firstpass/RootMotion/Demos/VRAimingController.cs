...
namespace RootMotion.Demos
{
	...
	public class VRAimingController : MonoBehaviour
	{
		...
		{
			float num = (UnityEngine.VR.InputTracking.GetLocalPosition(UnityEngine.VR.VRNode.LeftEye) - UnityEngine.VR.InputTracking.GetLocalPosition(UnityEngine.VR.VRNode.RightEye)).magnitude * 0.5f;
