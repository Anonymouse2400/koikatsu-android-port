...
public class FPControl2 : MonoBehaviour
{
	...
	public void Shoot()
	{
		...
		if (Physics.Raycast(ray, out hitInfo))
		{
			...
			DungeonControl2 dungeonControl = Utils.FindComponentInParents<DungeonControl2>(t);
			if (dungeonControl != null)
			{
				_currentWeapon.Shoot(dungeonControl, myCamera.transform.position, hitInfo.point);
			}
		}
	}
}
