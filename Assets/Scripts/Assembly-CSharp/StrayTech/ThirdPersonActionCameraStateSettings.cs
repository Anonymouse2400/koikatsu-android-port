...
{
	[Serializable]
	public class ThirdPersonActionCameraStateSettings : ICameraStateSettings
	{
		...
		public ThirdPersonActionCameraStateSettings(Vector3 targetOffset, bool mouseOrbit, Vector2 mouseOrbitDistance, Vector2 mousePitchRange, Vector2 mouseSensitivity, bool mouseInvertY, float motionSmoothing)
		{
