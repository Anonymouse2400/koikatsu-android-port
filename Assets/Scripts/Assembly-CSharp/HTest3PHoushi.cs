...
public class HTest3PHoushi : HTestActionBase
{
	...
	public HTest3PHoushi(HFlag.DeliveryMember _membar)
		: base(_membar)
	{
	...
	public override bool Proc()
	{
		...
		else if (animatorStateInfo.IsName("IN_Loop"))
		{
			...
			else if (!flags.isDebug && (voice.nowVoices[0].state == HVoiceCtrl.VoiceKind.breathShort || voice.nowVoices[1].state == HVoiceCtrl.VoiceKind.breathShort || (voice.nowVoices[0].state == HVoiceCtrl.VoiceKind.breath && voice.nowVoices[1].state == HVoiceCtrl.VoiceKind.breath)))
			{
				flag5 = true;
			}
			if (flag5)
		...
		else if (animatorStateInfo.IsName("M_OUT_Loop"))
		{
			...
			else if (!flags.isDebug && voice.nowVoices[0].state == HVoiceCtrl.VoiceKind.breath && voice.nowVoices[1].state == HVoiceCtrl.VoiceKind.breath && animatorStateInfo.normalizedTime > 2f)
			{
				flag6 = true;
			}
			if (flag6)
